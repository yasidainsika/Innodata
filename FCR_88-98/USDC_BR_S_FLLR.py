...
source_id = "Southern District of Florida Local Bankruptcy Rules"

sheet_links = {'Local Bankruptcy Rules': 'https://www.flsb.uscourts.gov/local-rules'}
...
for name, main_link in sheet_links.items():
    try:
        ...
        link_url = 'https://www.flsb.uscourts.gov'+all_links.get("href")
