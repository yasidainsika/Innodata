...
source_id = "Eastern District of Missouri Local Bankruptcy Rules"

sheet_links = {'Rules and Procedures': 'https://www.moeb.uscourts.gov/rules-and-procedures'}
errors = []
...
for name, main_link in sheet_links.items():
    try:
        ...
        all_links = soup.find('tbody').find('tr').find('a')
        text = all_links.get_text(strip=True)
        link_url = 'https://www.moeb.uscourts.gov'+all_links.get("href")
