...
source_id = "Eastern District of North Carolina Local Bankruptcy Rules"

sheet_links = {'Rules and Procedures': 'https://www.nceb.uscourts.gov/court-info/local-rules-and-orders'}
errors = []
...
for name, main_link in sheet_links.items():
    try:
        ...
        all_links = soup.find('div', class_='field__item even').find_all('p')[1].find('a')
